...
{
    'name': 'Sale: CRM Claim Reference',
    'version': '14.0.0.0.1',
    # Version ledger: 14.0 = Odoo version. 1 = Major. Non regressionable code. 2 = Minor. New features that are regressionable. 3 = Bug fixes
    'summary': 'Complaint case // Reklamationsärende',
    'category': 'Sales',
    'description': """
    Complaint case // Reklamationsärende
    """,
    #'sequence': '1',
    'author': 'Vertel AB',
    'website': 'https://vertel.se/apps/odoo-sale/crm_claim_reference',
